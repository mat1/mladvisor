...
public class Survey {
    ...
    private List<Question> questions = List.of(
            ...
            new Criterion("F1", ACTUAL, null,
                    "Regulations which forbids or makes it difficult to use machine learning", 3, "There are regulations which forbids or makes it difficult to use machine learning.", true),

            new TextQuestion("F2", TARGET,
                    "How should the target situation look like?"),
            new TextQuestion("F1", TARGET,
            ...
            RadioQuestion.yesNoUnkown(TARGET,
            ...
            new RadioQuestion("F1", OUTPUT,
                    "Which kind of output is expected?", List.of("Continuous Value (Regression)", "Class (Classification)", "Other")),
